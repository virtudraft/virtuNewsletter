 ...
 */
class CreateAllReportsProcessor extends modProcessor {
    ...
    public $objectType = 'virtunewsletter.CreateAllReportsProcessor';
    ...
    function process() {
        $output = $this->modx->virtunewsletter->setNewsletterQueue($this->getProperty('newsletter_id'));
...
return 'CreateAllReportsProcessor';
